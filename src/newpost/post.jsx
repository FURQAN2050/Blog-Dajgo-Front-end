...
class Post extends React.Component {
  ...
  postCategory() {
    ...
    payload.author_id = currentUser?.user_id;
  ...
  getCategories() {
    fetch(
      `${CONSTANTS.BASE_URL}${CONSTANTS.API_CONSTANTS.CATEGORIES.GET_ALL_CATEGORIES}/`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
              ...
              <div className="innerWrap">
                ...
                <div className="form-group row mb">
                  <label
                    ...
                    className="col-md-2 col-lg-2 col-form-label formlabels"
                  >
                    Category:
                  </label>
